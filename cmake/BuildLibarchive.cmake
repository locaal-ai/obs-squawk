...
if(WIN32)
    # get bzip2 precompiled from https://github.com/philr/bzip2-windows
    # use fetchcontent to download and extract the files
    include(FetchContent)
    FetchContent_Declare(
        bzip2
        URL "https://github.com/philr/bzip2-windows/releases/download/v1.0.8.0/bzip2-dev-1.0.8.0-win-x64.zip"
    )
...
ExternalProject_Add(libarchive-build
    URL ${LIBARCHIVE_URL}
...
set_property(TARGET libarchive::libarchive PROPERTY IMPORTED_LOCATION 
    ${INSTALL_DIR}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}archive${CMAKE_SHARED_LIBRARY_SUFFIX})
add_dependencies(libarchive::libarchive libarchive-build)
if(WIN32)
    set_property(TARGET libarchive::libarchive PROPERTY IMPORTED_IMPLIB
        ${INSTALL_DIR}/lib/${CMAKE_IMPORT_LIBRARY_PREFIX}archive${CMAKE_IMPORT_LIBRARY_SUFFIX})
